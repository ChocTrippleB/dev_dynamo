...
import { MessageCircle, ArrowRight, BookOpen, Calendar, CheckCircle, GraduationCap } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen  bg-gray-900 text-white font-sans flex flex-col relative overflow-hidden">
      ...
      className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-900/30 border border-indigo-500/30 mb-8 animate-in slide-in-from-bottom-4 fade-in duration-700 cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-slate-950"
    >
      <span className="text-indigo-300 text-sm font-medium">
        New: 2024 Past Papers Added 📚
      </span>
    </button>
...
{/* <img src="/chat.png" alt="Chat Icon" className="w-76 h-76 mr-2" /> */}
      <button
        onClick={handleLaunchApp}
        className="fixed bottom-8 right-8 p-4 hover:bg-indigo-700 text-white rounded-full shadow-2xl transition-transform hover:scale-110 z-50 flex items-center justify-center group"
        aria-label="Open Chat"
      >
        <img src="/chat.png" alt="Chat Icon" className="w-35 h-35 mr-2" />
